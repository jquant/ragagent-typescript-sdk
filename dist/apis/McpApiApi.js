...
exports.McpApiApi = void 0;
const runtime = require("../runtime");
const index_1 = require("../models/index");
/**
 *
 */
class McpApiApi extends runtime.BaseAPI {
    /**
    ...
    executeToolApiV1ToolsToolNamePostRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, index_1.ToolExecutionRequestToJSON)(requestParameters['toolExecutionRequest']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.ModelApiResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Execute a specific MCP tool  Executes the specified tool with the provided arguments and returns the result. The tool must be available in the MCP gateway\'s tool registry.
