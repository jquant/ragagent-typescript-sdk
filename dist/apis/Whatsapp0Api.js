...
class WhatsappApi extends runtime.BaseAPI {
     ...
     */
    legacyFlowEndpointWhatsappFlowPostRaw(initOverrides) {
     ...
     * Legacy Flow Endpoint
     */
    legacyFlowEndpointWhatsappFlowPost(initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.legacyFlowEndpointWhatsappFlowPostRaw(initOverrides);
