 ...
 */
export function instanceOfUIEventPayload(value) {
...
export function UIEventPayloadFromJSON(json) {
    return UIEventPayloadFromJSONTyped(json, false);
}
export function UIEventPayloadFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function UIEventPayloadToJSON(json) {
    return UIEventPayloadToJSONTyped(json, false);
}
export function UIEventPayloadToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
