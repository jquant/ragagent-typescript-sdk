...
exports.RagAgentClient = void 0;
exports.initializeChatSession = initializeChatSession;
exports.sendChatMessage = sendChatMessage;
exports.listGatewayTools = listGatewayTools;
...
class RagAgentClient {
    constructor(opts = {}) {
        ...
        this.config = new runtime_1.Configuration({ basePath: this.baseUrl });
    }
    //----------------------------------------------
    // Tools
    //----------------------------------------------
    ...
    agentDirectMessageTool(params) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const api = new index_1.UiEventsApi(this.config);
...
exports.RagAgentClient = RagAgentClient;
//--------------------------------------------------
// Convenience helper functions (mirroring legacy SDK)
//--------------------------------------------------
function initializeChatSession(_a) {
